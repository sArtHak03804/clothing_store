    ...
    <section class="content">
      ...
      <div class="msg"></div>
        ...
        ?>
                ...
                <td><img src="<?php echo 'category/'.$row['category_thumb']; ?>" alt="category Thumbnail" height="70px" width="80px" ></td>
                <?php if ($user_role=="Admin"||$user_role=="Super Admin"){?>   
                <td><a href="#" data-id="<?php echo $row['category_id'];?>" class="delete_cat"><i class="fa-solid fa-trash-can-arrow-up"></i></a></td>
                <?php }?>
                <td><a href= "update_category.php?category_id=<?php echo $row['category_id']?>"><i class="fa-solid fa-pencil"></i></a></td>
                  </tr>
                  <?php
                     }
                     ?>
