<?php
    ...
    $query=mysqli_query($conn,"SELECT * from clothing_sub_category");
      ...
      <div class="msg"></div>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class= "">
                    ...
                    <button><i class="far fa-edit nav-icon"></i><a href="add_sub_category_form.php">ADD SUB-CATEGORY</a></button>
                   </ol>
                </div>
              </div>
              <!-- /.card-header -->
        ...
        ?>
                ...
                <td>
                  ...
                  <td>
                    <?php echo $row['sub_category_title'] ;
                     ?>
                </td>
                <td>
                ...
                <?php if ($user_role=="Admin"||$user_role=="Super Admin"){?>   
                <td><a href="#" data-id="<?php echo $row['sub_category_id'];?>" class="delete_sub_cat"><i class="fa-solid fa-trash-can-arrow-up"></i></a></td>
                <?php }?>
                <td><a href= "update_sub_category.php?sub_category_id=<?php echo $row['sub_category_id']?>"><i class="fa-solid fa-pencil"></i></a></td>
              </tr>
                  <?php
                     }
                     ?>
