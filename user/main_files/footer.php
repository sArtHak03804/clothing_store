		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<ul>
						<?php 
						while ($row1= mysqli_fetch_array($category_data)) {
						?>
...
echo $row1['category_title'];
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						Any questions? Let us know in store at 32th floor, Shivalik Curv, Gift City, Gandhinagar 328984 or
						<br> Call us on (+1) 96 716 6879
					</p>
