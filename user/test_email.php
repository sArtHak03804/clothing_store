...
$to ="patelsarthak666@gmail.com"; // Your Email Address here
...
?>
<?php 
$message .= '<body style="background-color:#f2fafc;">
        <div class="container" >
    ...
    '
    .$result = mysqli_query($conn, "SELECT * FROM placeorder WHERE user_id = 24");
    ...
    ' 
          ...
          <div class="order-details">
            <div style="background-color: transparent">
              ...
              <!-- first line (Item, Price, Quantity) starts  -->
                <div style="background-color: transparent">
              ...
              //first line (Item, Price, Quantity) ends  -->
    //<!-- Iteam Name starts -->
    ...
    $total= 0; // Initialize total before the loop
     while ($row = mysqli_fetch_array($result))
     {
       ...
       $product_final_total = $row['quantity'] * $product_info['product_price'];
       $total += $product_final_total;
